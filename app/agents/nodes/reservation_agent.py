...
from app.agents.tools.reservation_tools import ver_mesas_disponibles, reservar_mesa, cancelar_mi_reserva
...
_TOOLS = [ver_mesas_disponibles, reservar_mesa, cancelar_mi_reserva, ver_eventos_disponibles, ver_metodos_de_pago]
